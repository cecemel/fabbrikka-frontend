...
export default Ember.Component.extend({
  ...
  productType: Ember.computed.reads('item.productVariant.product.type'), 
  isFreeTryOutAllowed: Ember.computed('cartService.isFreeTryOutAllowed', 'productType', function(){
